...
class SepResNet50V2(tf.keras.Model):
    def __init__(self, in_shape, num_classes):
        super(SepResNet50V2, self).__init__()
        ...
        self.sep_conv_3x3_s1 = tf.keras.layers.SeparableConv2D(64,
                                                               kernel_size=(3, 3),
                                                               strides=(2, 2),
                                                               padding='same',
                                                               dilation_rate=(1, 1),
        ...
        self.res_block_3 = ResidualBlock(256, 6, strides=2)
