...
class SepResNet152V2(tf.keras.Model):
    def __init__(self, in_shape, num_classes):
        super(SepResNet152V2, self).__init__()
        ...
        self.res_block_2 = ResidualBlock(128, 8, strides=2)
        self.res_block_3 = ResidualBlock(256, 36, strides=2)
